...
assert.doesNotMatch(initMappedPocAreaMapBody, /areaOneTreeSelect|areaOneTreeList|openAreaOneTree|updateAreaOneTreeSelection/, "Area 001 pin-selection controls must not alter Areas 002-005");
