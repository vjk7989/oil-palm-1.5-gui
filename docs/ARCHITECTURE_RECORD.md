...
- Before the Area 002 replacement documented below, the active portfolio ranged from 112 through 149 trees. With both editable survey workflows it ranges from 134 through 200: 27 fixed infected, 20 fixed suspected, and 87 fixed healthy records, plus zero through 37 added Area 001 records and zero through 29 added Area 002 records distributed by their saved statuses.
